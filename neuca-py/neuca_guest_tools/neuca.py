...
class NEucaCometData(NEucaData):
    def __init__(self, userdata):
        ...
        comet_vm_properties_file.write("comet.client.keystore=" + self.comet_vm_keystore_path + "/n")
        comet_vm_properties_file.write("comet.client.keystore.pass=accumuloAuth" + "/n")
        comet_vm_properties_file.write("comet.client.truststore=" + self.comet_vm_truststore_path + "/n")
        comet_vm_properties_file.write("comet.client.truststore.pass=accumuloAuth" + "/n")
        comet_vm_properties_file.write("comet.client.accumulo.instance=comet" + "/n")
        comet_vm_properties_file.write("comet.client.zookeeperse.hosts=comet1.renci.org,comet2.renci.org,comet3.renci.org,comet4.renci.org" + "/n")
        comet_vm_properties_file.write("comet.client.table.main=cometMain" + "/n")
        comet_vm_properties_file.write("comet.client.accumulo.user.default=root" + "/n")
        comet_vm_properties_file.write("comet.client.accumulo.user.default.pass=accumuloAuth" + "/n")
        comet_vm_properties_file.write("comet.client.table.ifce=interfaces" + "/n")
    ...
    def __decode_keystores(self):
        ...
        with open (keystore64_path, "r") as keystore64_file:
            with open (keystore_path, "wb") as keystore_file:
                ...
                base64.decode(keystore64_file,keystore_file)
        ...
        with open (truststore64_path, "r") as truststore64_file:
            with open (truststore_path, "wb") as truststore_file:
                ...
                base64.decode(truststore64_file,truststore_file)
    ...
    def getAllInterfaces(self):
        ...
        for iface in ifaces:
            ...
            mac = iface
            ifaces_rtn.append([mac, ifaces[mac]['state'] + ":" + ifaces[mac]['protocol'] + ":" + ifaces[mac]['ip_address'] ])
        #
